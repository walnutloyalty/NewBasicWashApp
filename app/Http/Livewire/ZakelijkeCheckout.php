...
class ZakelijkeCheckout extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.checkout.zakelijke-checkout', ['subscriptions' => $subscriptions, 'validateOrCreateUser' => $validateOrCreateUser, 'addLicense' => $addLicense]);
    }
