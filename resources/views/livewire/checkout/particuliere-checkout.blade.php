    ...
    <div x-data="{ step: 1 }" @step1.window="step = 1" @step2.window="step = 2" @step3.window="step = 3"
        ...
        <main>
            <div x-show="step === 1"
                ...
                <livewire:summary/>
                <div class="mt-10 border-t border-gray-200 pt-6 sm:flex sm:justify-between">
            ...
            <div x-show="step === 3"
                 class="pt-16 relative mx-auto grid max-w-7xl grid-cols-1 gap-x-16 lg:grid-cols-2 lg:px-8 xl:gap-x-48">
                <div class="mx-auto max-w-lg">
                    ...
                    <section aria-labelledby="shipping-heading" class="my-24">
