                ...
                <div>
                    ...
                    <form action="#" class="mt-6 flex">
                        ...
                        <input type="text" name="userLicensePlate" wire:model="licenseplate" id="userLicensePlate"
                            ...
                            placeholder="Enter a licenseplate" @keyup="if (document.getElementsByClassName('addLicenseplate').length == 0 && $event.target.value.replace('-', '').replace('-', '').length === 6) { document.getElementById('addLicensePlateButton').click() }">
                        <button type="button" wire:click="addLicensePlate" wire:loading.attr="disabled"
                            wire:target="addLicensePlate" id="addLicensePlateButton"
                ...
                <div class="mt-10">
                    ...
                    <ul role="list" class="mt-4 divide-y divide-gray-200 border-b border-t border-gray-200">
                        @foreach ($licenseplates as $key => $plate)
                            <li
                                class="addLicenseplate relative bg-white px-4 py-5 focus-within:ring-2 focus-within:ring-inset focus-within:ring-indigo-600 hover:bg-gray-50">
                    ...
                    <section aria-labelledby="summary-heading" class="mt-10">
                        ...
                        <div class="mt-10 grid grid-cols-1 gap-4 sm:grid-cols-2">
                            ...
                            @else
                                ...
                                <span x-text="nav_step === 2 ? 'Checkout' : 'Next'" wire:loading.remove wire:target="next" @click="window.scrollTo(0,0)">
