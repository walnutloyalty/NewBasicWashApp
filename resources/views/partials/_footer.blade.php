        ...
        <div class="xl:grid xl:grid-cols-3 xl:gap-8">
            <div class="space-y-8 xl:col-span-1">
                <img class="h-10" src="{{ asset('media/logos/basic-wash-logo.png') }}"
                     alt="Basic Wash">
                <div>
                    <a href="#"><p class="text-base text-white font-extrabold hover:underline cursor-pointer">Algemene voorwaarden</p></a>
                    <a href="#"><p class="text-base text-white font-extrabold hover:underline cursor-pointer">Abonnements voorwaarden</p></a>
                </div>
