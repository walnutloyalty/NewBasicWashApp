        ...
        <div class="mt-20 max-w-lg sm:mx-auto md:max-w-none">
            <div class="grid grid-cols-1 gap-y-16 md:grid-cols-3 md:gap-x-12 md:gap-y-16">
                <div
                    ...
                    <a href="#">
                        <img class="rounded-t-lg" src="https://picsum.photos/500/300" alt=""/>
                    </a>
                    <div class="p-5">
                        <a href="#">
                        ...
                        <p class="mb-3 font-normal text-gray-700">Met onze abonnementen kan jij
                            onbeperkt je auto wassen op al onze locaties. Heb je net je auto gewassen maar hij is al
                            weer vies? Kom gauw weer langs!
                        </p>
                        <a href="#"
