        ...
        <div class="flex items-center justify-between py-6 md:justify-start md:space-x-10">
            ...
            <nav class="hidden space-x-10 md:flex">
                <div x-data="{ menuItem1: false }" class="relative">
                    ...
                    <button type="button" @click="menuItem1 = true"
                            class="group text-white transition-all duration-300 ease-in-out inline-flex items-center"
                            aria-expanded="false">
                        <span class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">Solutions</span>
                        <!--
                ...
                <div class="group text-white transition-all duration-300 ease-in-out inline-flex items-center">
                    <a href="#" class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">Pricing</a>

                </div>
                <div class="group text-white transition-all duration-300 ease-in-out inline-flex items-center">
                    <a href="#" class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">Docs</a>

                </div>

                <div x-data="{ menuItem2: false }" class="relative">
                    <!-- Item active: "text-gray-900", Item inactive: "text-gray-500" -->
                    <button type="button" @click="menuItem2 = true"
                            class="group text-white transition-all duration-300 ease-in-out inline-flex items-center"
                            aria-expanded="false">
                        <span class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">More</span>
                        <!--
                          Heroicon name: mini/chevron-down
                    ...
                    <!--
                      ...
                      Leaving: "transition ease-in duration-150"
                        ...
                        To: "opacity-0 translate-y-1"
                    -->
                    <div x-show="menuItem2" @click.away="menuItem2 = false" class="absolute left-1/2 z-10 mt-3 w-screen max-w-md -translate-x-1/2 transform px-2 sm:px-0">
                        <div class="overflow-hidden rounded-lg shadow-lg ring-1 ring-black ring-opacity-5">
                            <div class="relative grid gap-6 bg-white px-5 py-6 sm:gap-8 sm:p-8">
                                <a href="#" class="-m-3 flex items-start rounded-lg p-3 hover:bg-gray-50">
                                ...
                                <div>
                                    ...
                                    <ul role="list" class="mt-4 space-y-4">
                                        <li class="truncate text-base">
                                            <a href="#" class="font-medium text-gray-900 hover:text-gray-700">Boost your
                                                conversion rate</a>
                                        </li>

                                        <li class="truncate text-base">
                                            <a href="#" class="font-medium text-gray-900 hover:text-gray-700">How to use
                                                search engine optimization to drive traffic to your site</a>
                                        </li>
