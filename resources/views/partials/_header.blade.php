...
<div x-data="{ mobile: false }" class="relative bg-pink-600">
    ...
    -->
    <div x-show="mobile" x-data="{ mobileSub1: false, mobileSub2: false, mobileSub3: false }" class="absolute inset-x-0 top-0 origin-top-right transform p-2 transition md:hidden z-50">
        <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            <div class="px-5 pt-5 pb-6">
                ...
                <div>
                    <nav class="grid gap-y-8">
                        <a href="#" class="-m-3 flex items-center rounded-md p-3" @click="mobileSub1 = true; mobileSub2 = false; mobileSub3 = false" :class="mobileSub1 ? 'bg-pink-100' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 flex-shrink-0 text-pink-600">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 3h1.386c.51 0 .955.343 1.087.835l.383 1.437M7.5 14.25a3 3 0 00-3 3h15.75m-12.75-3h11.218c1.121-2.3 2.1-4.684 2.924-7.138a60.114 60.114 0 00-16.536-1.84M7.5 14.25L5.106 5.272M6 20.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0zm12.75 0a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />
                            </svg>
                            <span class="ml-3 text-base font-medium text-gray-900">Webshop</span>
                        </a>

                        <a href="#" class="-m-3 flex items-center rounded-md p-3" @click="mobileSub2 = true; mobileSub1 = false; mobileSub3 = false" :class="mobileSub2 ? 'bg-pink-100' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 flex-shrink-0 text-pink-600">
                        ...
                        <a href="#" class="-m-3 flex items-center rounded-md p-3" @click="mobileSub3 = true; mobileSub1 = false; mobileSub2 = false" :class="mobileSub3 ? 'bg-pink-100' : ''">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 flex-shrink-0 text-pink-600">
            ...
            <div x-show="mobileSub1" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('particulier') }}" class="text-base font-medium @if(Request::routeIs('particulier')) text-pink-600 @endif">Particulier</a>

                    <a href="{{ route('zakelijk') }}" class="text-base font-medium @if(Request::routeIs('zakelijk')) text-pink-600 @endif">Zakelijk wassen</a>
                </div>
            </div>
            <div x-show="mobileSub2" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('locaties') }}" class="text-base font-medium @if(Request::routeIs('locaties')) text-pink-600 @endif">Al onze Basic Wash locaties</a>
                    <a href="{{ route('breda') }}" class="text-base font-medium @if(Request::routeIs('breda')) text-pink-600 @endif">Breda</a>
                    <a href="{{ route('hellevoetsluis') }}" class="text-base font-medium @if(Request::routeIs('hellevoetsluis')) text-pink-600 @endif">Hellevoetsluis</a>
                    <a href="{{ route('sint-willebrord') }}" class="text-base font-medium @if(Request::routeIs('sint-willebrord')) text-pink-600 @endif">Sint willebrord</a>
                    <a href="{{ route('terheijden') }}" class="text-base font-medium @if(Request::routeIs('terheijden')) text-pink-600 @endif">Terheijden</a>
                    <a href="{{ route('ulvenhout') }}" class="text-base font-medium @if(Request::routeIs('ulvenhout')) text-pink-600 @endif">Ulvenhout</a>
                </div>
            </div>
            <div x-show="mobileSub3" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('klantenportaal') }}" class="text-base font-medium @if(Request::routeIs('klantenportaal')) text-pink-600 @endif">Klantenportaal</a>
                    <a href="{{ route('kentekencheck') }}" class="text-base font-medium @if(Request::routeIs('kentekencheck')) text-pink-600 @endif">Kentekencheck</a>
                    <a href="{{ route('FAQ') }}" class="text-base font-medium @if(Request::routeIs('FAQ')) text-pink-600 @endif">F.A.Q.</a>
                    <a href="{{ route('invulformulier') }}" class="text-base font-medium @if(Request::routeIs('invulformulier')) text-pink-600 @endif">Invulformulier</a>
                    <a href="{{ route('over-ons') }}" class="text-base font-medium @if(Request::routeIs('over-ons')) text-pink-600 @endif">Over ons</a>
                    <a href="{{ route('contact') }}" class="text-base font-medium @if(Request::routeIs('contact')) text-pink-600 @endif">Contact</a>
                </div>
            </div>
        </div>
    </div>
