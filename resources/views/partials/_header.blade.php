            ...
            <nav class="hidden space-x-10 md:flex">
                <div x-data="{ menuItem1: false }" class="relative">
                    <button type="button" @click="menuItem1 = true" :class="menuItem1 ? 'text-cyan-500' : ''"
                            ...
                            aria-expanded="false">
                        <span
                            class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">{{__("Webshop")}}</span>
                ...
                <div x-data="{ menuItem2: false }" class="relative">
                    <button type="button" @click="menuItem2 = true" :class="menuItem2 ? 'text-cyan-500' : ''"
                            ...
                            aria-expanded="false">
                        <span
                            class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">{{__("Locaties")}}</span>
                        <svg class="text-white ml-2 h-5 w-5 group-hover:text-cyan-500"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                             aria-hidden="true">
                            <path fill-rule="evenodd"
                ...
                <div x-data="{ menuItem3: false }" class="relative">
                    <button type="button" @click="menuItem3 = true" :class="menuItem3 ? 'text-cyan-500' : ''"
                            ...
                            aria-expanded="false">
                        <span
                            class="bg-left-bottom bg-gradient-to-r from-cyan-500 to-cyan-500 bg-[length:0%_2px] bg-no-repeat group-hover:bg-[length:100%_2px] transition-all duration-500 ease-out font-bold text-2xl group-hover:text-cyan-500">{{__("Klantenservice")}}</span>
                        <svg class="text-white ml-2 h-5 w-5 group-hover:text-cyan-500"
                             xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor"
                             aria-hidden="true">
                            <path fill-rule="evenodd"
        ...
        <div class="divide-y-2 divide-gray-50 rounded-lg bg-white shadow-lg ring-1 ring-black ring-opacity-5">
            ...
            <div x-show="mobileSub1" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('particulier') }}"
                       class="text-base font-medium @if(Request::routeIs('particulier')) text-pink-600 @endif">{{__("Particulier")}}</a>
                    <a href="{{ route('zakelijk') }}"
                       class="text-base font-medium @if(Request::routeIs('zakelijk')) text-pink-600 @endif">{{__("Zakelijk wassen")}}</a>
                </div>
            </div>
            <div x-show="mobileSub2" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('locaties') }}"
                       class="text-base font-medium @if(Request::routeIs('locaties')) text-pink-600 @endif">{{__("Al onze Basic Wash locaties")}}</a>
                    <a href="{{ route('breda') }}"
            ...
            <div x-show="mobileSub3" class="space-y-6 py-6 px-5">
                <div class="grid grid-cols-2 gap-y-4 gap-x-8">
                    <a href="{{ route('klantenportaal') }}"
                       class="text-base font-medium @if(Request::routeIs('klantenportaal')) text-pink-600 @endif">{{__("Klantenportaal")}}</a>
                    <a href="{{ route('kentekencheck') }}"
                       class="text-base font-medium @if(Request::routeIs('kentekencheck')) text-pink-600 @endif">{{__("Kentekencheck")}}</a>
                    <a href="{{ route('FAQ') }}"
                       class="text-base font-medium @if(Request::routeIs('FAQ')) text-pink-600 @endif">{{__("F.A.Q.")}}</a>
                    <a href="{{ route('invulformulier') }}"
                       class="text-base font-medium @if(Request::routeIs('invulformulier')) text-pink-600 @endif">{{__("Invulformulier")}}</a>
                    <a href="{{ route('over-ons') }}"
                       class="text-base font-medium @if(Request::routeIs('over-ons')) text-pink-600 @endif">{{__("Over ons")}}</a>
                    <a href="{{ route('contact') }}"
                       class="text-base font-medium @if(Request::routeIs('contact')) text-pink-600 @endif">{{__("Contact")}}</a>
                </div>
            </div>
        </div>
    </div>
