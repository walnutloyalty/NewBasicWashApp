                ...
                <div class="grid grid-cols-1 gap-y-20 lg:grid-cols-3 lg:gap-y-0 lg:gap-x-8">
                    <div class="flex flex-col rounded-2xl bg-white shadow-xl">
                        <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                            ...
                            <h3 class="text-xl font-medium text-blue-gray-900">Basic Wash - Facebook</h3>
                            <p class="mt-4 text-base text-blue-gray-500">Stuur ons een bericht via Messenger!
                                Houdt ons kanaal op Facebook goed in de gaten voor de laatste 'nieuwtjes' en actuele
                                aanbiedingen.</p>
                        </div>
                    ...
                    <div class="flex flex-col rounded-2xl bg-white shadow-xl">
                        <div class="relative flex-1 px-6 pt-16 pb-8 md:px-8">
                            ...
                            <h3 class="text-xl font-medium text-blue-gray-900">Basic Wash - 0180 643 643</h3>
                            <p class="mt-4 text-base text-blue-gray-500">Bel ons voor jouw dringende vragen!
                                Onze klantenservice zit klaar om je te woord te staan.</p>
                        </div>
                        <div class="rounded-bl-2xl rounded-br-2xl bg-blue-gray-50 p-6 md:px-8">
