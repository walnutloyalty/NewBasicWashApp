    ...
    <div class="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
        ...
        <div class="lg:grid lg:grid-cols-2 lg:gap-x-12 xl:gap-x-16">
            <form class="max-w-xl">
                ...
                <div class="mt-6"><a href="{{ route('particuliere-checkout-step1') }}"
                                     class="w-full rounded-md border border-transparent bg-pink-600 py-3 px-4 text-base font-medium text-white shadow-sm hover:bg-cyan-600 focus:outline-none focus:ring-2 focus:ring-cyan-500 focus:ring-offset-2 focus:ring-offset-gray-50">Ga
                        terug</a></div>
            </form>
                ...
                <div class="mt-4 rounded-lg border border-gray-200 bg-white shadow-sm">
                    ...
                    <dl class="space-y-6 border-t border-gray-200 py-6 px-4 sm:px-6">
                        <div class="flex items-center justify-between">
                            <dt class="text-sm">Maandelijks</dt>
