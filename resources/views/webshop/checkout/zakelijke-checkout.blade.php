<x-app-layout>
    <div class="bg-gray-50">
        <div class="mx-auto max-w-2xl px-4 pt-16 pb-24 sm:px-6 lg:max-w-7xl lg:px-8">
            ...
            <h2 class="text-2xl font-bold mb-6">Vul hier je gegevens in</h2>
                    ...
                    <div>
                        ...
                        <fieldset class="mt-10 border-t border-gray-200 pt-10">
                            ...
                            <div x-data="{ choice: '' }" class="space-y-4">
                                <label @click="choice = 'Personen auto'"
                                       ...
                                       :class="choice === 'Personen auto' ? 'border-pink-600 ring-2 ring-pink-600' : ''">
                                    <input type="radio" name="personen-auto" class="sr-only"
                                           aria-labelledby="server-size-0-label"
                                           aria-describedby="server-size-0-description-0 server-size-0-description-1">
                                    <span class="flex items-center">
                                        <span class="flex flex-col text-sm">
                                            <span id="server-size-0-label" class="font-medium text-gray-900">Personenauto BW</span>
                                    ...
                                    <span id="server-size-0-description-1"
                                        ...
                                        <span class="font-medium text-gray-900">€ 290,40</span>
                                        <span class="ml-1 text-gray-500 sm:ml-0">/yr</span>
                                    </span>
                                    <span class="pointer-events-none absolute -inset-px rounded-lg border-2"
                                          aria-hidden="true"></span>
                                </label>
                                <label @click="choice = 'Busjes'"
                                       class="relative block cursor-pointer rounded-lg border bg-white px-6 py-4 shadow-sm focus:outline-none sm:flex sm:justify-between"
                                       :class="choice === 'Busjes' ? 'border-pink-600 ring-2 ring-pink-600' : ''">
                                    <input type="radio" name="busjes" class="sr-only"
                                    ...
                                    <span class="flex items-center">
                                        <span class="flex flex-col text-sm">
                                            <span id="server-size-1-label"
                                                  class="font-medium text-gray-900">Busjes BW</span>
                                    ...
                                    <span id="server-size-1-description-1"
                                          class="mt-2 flex text-sm sm:mt-0 sm:ml-4 sm:flex-col sm:text-right">
                                        <span class="font-medium text-gray-900">€ 363,00</span>
                                        <span class="ml-1 text-gray-500 sm:ml-0">/yr</span>
                                    </span>
                                    <span class="pointer-events-none absolute -inset-px rounded-lg border-2"
                                          aria-hidden="true"></span>
                                </label>
                                <label @click="choice = 'Taxi'"
                                       class="relative block cursor-pointer rounded-lg border bg-white px-6 py-4 shadow-sm focus:outline-none sm:flex sm:justify-between"
                                       :class="choice === 'Taxi' ? 'border-pink-600 ring-2 ring-pink-600' : ''">
                                    <input type="radio" name="taxi" class="sr-only"
                                           aria-labelledby="server-size-2-label"
                                           aria-describedby="server-size-2-description-0 server-size-2-description-1">
                                    <span class="flex items-center">
                                        <span class="flex flex-col text-sm">
                                            <span id="server-size-2-label" class="font-medium text-gray-900">Taxi's BW</span>
                                    ...
                                    <span id="server-size-2-description-1"
                                          class="mt-2 flex text-sm sm:mt-0 sm:ml-4 sm:flex-col sm:text-right">
                                        <span class="font-medium text-gray-900">€ 435,60</span>
                                        <span class="ml-1 text-gray-500 sm:ml-0">/yr</span>
                                    </span>
                                    <span class="pointer-events-none absolute -inset-px rounded-lg border-2"
                                          aria-hidden="true"></span>
                        ...
                        <div class="mt-10 border-t border-gray-200 pt-10">
                            ...
                            <div class="sm:col-span-4 mt-4">
                                <label for="fin" class="block text-sm font-medium text-gray-700">Fiscaal Identificatie Nummer</label>
                                <div class="mt-1">
                                    <input id="email" name="fin" type="text"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-600 focus:ring-cyan-600 sm:text-sm">
                                </div>
                            </div>
                            <div class="sm:col-span-4 mt-4">
                                ...
                                <div class="mt-1">
                                    <input id="kvk" name="kvk" type="text"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-600 focus:ring-cyan-600 sm:text-sm">
                                </div>
                            </div>
                            <div class="sm:col-span-4 mt-4">
                            ...
                            <div class="sm:col-span-4 mt-4">
                                <label for="postcode" class="block text-sm font-medium text-gray-700 max-w-[5rem]">Postcode</label>
                                <div class="mt-1">
                                    <input id="postcode" name="postcode" type="text"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-600 focus:ring-cyan-600 sm:text-sm">
                                </div>
                            ...
                            <div class="sm:col-span-4 mt-4">
                                ...
                                <div class="mt-1">
                                    <input id="stad" name="stad" type="text"
                                           class="block w-full rounded-md border-gray-300 shadow-sm focus:border-cyan-600 focus:ring-cyan-600 sm:text-sm">
                                </div>
                            </div>
                        </div>
